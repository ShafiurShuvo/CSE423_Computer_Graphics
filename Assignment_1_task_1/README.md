...
## Overview
This assignment demonstrates the use of OpenGL primitives (`GL_POINTS`, `GL_LINES`, `GL_TRIANGLES`) to create a scene featuring a house under rainfall. The program also includes interactive controls to modify the rain's direction and change the background color to simulate day and night transitions.
