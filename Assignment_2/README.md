# OpenGL Assignment: Catch the Diamonds!

## Overview
In this project, a 2D game called **"Catch the Diamonds!"** is implemented using OpenGL. The player must catch falling diamonds using a movable catcher before they hit the ground. The game becomes progressively more challenging as the speed of falling diamonds increases.
