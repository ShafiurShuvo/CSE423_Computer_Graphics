# OpenGL Assignment 3: Shooting Game

## Overview
This assignment is a **2D Shooting Game** implemented using OpenGL. The player controls a **circle shooter** and must shoot falling circles before they reach the bottom. The game tracks scores and includes game-over conditions, difficulty scaling, and interactive buttons.
